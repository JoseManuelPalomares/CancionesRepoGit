...
/**
 * Ejercicio de prueba de Canciones
 * @author Palomares
 *
 */
...
public class PruebaCancion {
	...
	/**
	 * En esta clase vamos a hacer pruebas con la clase canción
	 * @param args
	 * @see Cancion#SiguienteCancion(Cancion[], String), recorre las canciones y pasa a la siguiente
	 */
